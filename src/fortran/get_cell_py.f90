...
CONTAINS
    ...
    SUBROUTINE get_cell_box(n_snap, x0, y0, z0, dx, dom_list)
    ...
    CALL read_cell(ftype, dom_list, n_thread)
    ...
    !! ALLOCATE
    !!-----
    CALL get_cell_allocate(nn, n_varh+n_dim+1)
...
!! ROUTINES FOR MEMORY
!!-----
    SUBROUTINE get_cell_allocate(npart, ndim)
    IMPLICIT NONE
    ...
    SUBROUTINE get_cell_deallocate()
    IMPLICIT NONE
