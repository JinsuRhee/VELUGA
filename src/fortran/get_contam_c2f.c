...
void get_contam(int argc, void *argv[])
{
  ...
  double *xc, *yc, *zc, *aperture;
  int *larr;
  double *darr;
  double *dm_xp, *dm_mm;
  double *conf_n, *conf_m;
  ...
  get_contam_(larr, darr, dir_raw->s, xc, yc, zc, aperture, dm_xp, dm_mm, conf_n, conf_m);   /* Compute sum */}
